...
In this tutorial we looked at decorators in distr6 to obtain numeric results, methods for statistical modelling and imputation methods for missing p/d/q/r functions. In the [next tutorial](https://alan-turing-institute.github.io/distr6/articles/webs/wrappers.html) we look at the next big feature in distr6, wrappers.
