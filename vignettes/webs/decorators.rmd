...
The final implemented decorator is used to impute missing d/p/q/r methods. We will return to the `FunctionImputation` decorator in a [future tutorial](https://alan-turing-institute.github.io/distr6/articles/webs/custom_distributions.html) which looks at constructing custom distributions.
...
library(magrittr)
Normal$new() %>% decorate(c("CoreStatistics", "ExoticStatistics"))
```
