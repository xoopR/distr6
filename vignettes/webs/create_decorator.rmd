...
Note: if the user has already decorated their distribution with `FunctionImputation` then even if your decorator thinks the results are analtic, they are not. However this is taken into account by the warning message in the imputed d/p/q/r methods.
