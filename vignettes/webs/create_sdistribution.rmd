...
Normal$set("public","initialize",function(mean = 0, var = 1, sd = NULL, prec = NULL,
  ...
  super$initialize(decorators = decorators, pdf = pdf, cdf = cdf, quantile = quantile,
                   ...
                   distrDomain = Reals$new(zero = T), symmetric = TRUE, type = Reals$new(),
...
4. The super-class constructor is called, arguments passed to this include the decorators arguments, the d/p/q/r methods, the properties of the distribution including: support (SetInterval); distrDomain (SetInterval); symmetric (logical).
And the traits of the distribution inlcuding: type (SetInterval); variateForm ("univariate"/"multivariate"/"matrixvariate"); valueSupport ("discrete"/"continuous"/"mixture").
