...
Note that `traits` is a variable (no parentheses after it) whereas calling specific traits is a method and thus require parentheses, this is because traits are class properties.
...
To view properties in distr6, we use the `properties()` method, note that this is a method (with parentheses) and not a variable:
```{r}
