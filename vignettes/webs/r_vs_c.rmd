...
Note: We did interface the d/p/q/r methods of some distributions from other packages. We interfaced everything directly from R stats. Additionally we interefaced the d/p/q/r functions in a couple of distirbutions from extraDistr [@extradistr], usually because they had derived some tricky inverse cdfs.
