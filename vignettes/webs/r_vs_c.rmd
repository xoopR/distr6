...
3. To make the p/d/q/r/ methods visible to the user
4. Tested C implementations were not vastly quicker

Note: We did interface the p/d/q/r methods of some distributions from other packages. We interfaced everything directly from R stats. Additionally we interefaced the p/d/q/r functions in a couple of distirbutions from extraDistr [@extradistr], usually because they had derived some tricky inverse cdfs.
