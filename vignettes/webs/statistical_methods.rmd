...
In this tutorial we looked at using the p/d/q/r functions in distr6 and accessing other statistical results. In the [next tutorial](https://alan-turing-institute.github.io/distr6/articles/webs/properties_traits.html) we take a quick look at distribution properties and traits, whilst trying not to get into too big a discussion about object-oriented programming!
