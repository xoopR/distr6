...
Uniform$set("active","name","Uniform")
Uniform$set("active","short_name","Unif")
Uniform$set("active","description","Uniform Probability Distribution.")
Uniform$set("active","packages","stats")
