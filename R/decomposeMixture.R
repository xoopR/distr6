...
#
#   # return(list(discrete = list(models = disc_models, support = disc_support, weights = disc_weights),
#   #      continuous = list(models = cont_models, support = cont_support, weights = cont_weights)))
