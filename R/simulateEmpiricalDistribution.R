...
#'
#' The `seed` param ensures that the same samples can be reproduced and is more convenient than using the
#' [set.seed()] function each time before use. If \code{set.seed} is \code{NULL} then the seed is left
