...
Logistic$set("public", "mgf", function(t){
  ...
  if (-1/self$getParameterValue("scale") < t & t < 1/self$getParameterValue("scale")) 
    return(exp(self$getParameterValue("location") * t) * beta(1-self$getParameterValue("scale")*t, 1+self$getParameterValue("scale")*t))
  else 
    return(NaN)
...
Logistic$set("public", "cf", function(t){
  return(exp((1i * self$getParameterValue("location")*t) * (pi*self$getParameterValue("scale")*t)/(sinh(pi*self$getParameterValue("scale")*t))))
})
...
Logistic$set("public","initialize",function(location = 0, scale = 1,
  ...
  pdf <- function(x1) dlogis(x1, self$getParameterValue("location"), self$getParameterValue("scale"))
  cdf <- function(x1) plogis(x1, self$getParameterValue("location"), self$getParameterValue("scale"))
  quantile <- function(p) qlogis(p, self$getParameterValue("location"), self$getParameterValue("scale"))
