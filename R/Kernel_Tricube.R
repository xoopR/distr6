  ...
  public = list(
    ...
    cdfSquared2Norm = function(x = 0, upper = 0) {
      ...
      f1 <- function(upper, x) {
        ...
        ret1 = (1/26244)*(43379/33 + (28*upper^21)/3 - (6561*x)/2 -
                           98*upper^20*x + (252315*x^2)/247 + (8820*upper^19*x^2)/19 + (4900*x^3)/3 +
                           (229635*x^4)/187 - 1701*x^5 - 1078*x^6 + (17010*x^8)/13 - (3605*x^9)/6 +
                           (3969*x^10)/ 11 - (2268*x^11)/11 - (18*x^15)/143 - (7*x^21)/138567 -
                           (280/3)*upper^18*(-1 + 14*x^3) - 63*upper^16*x^2*(-55 + 49*x^3) +
                           (840/17)*upper^17*x*(-17 + 49*x^3) - (70/3)*upper^3*(-1 + x^3)^2*(-280 - 729*x^2 + 280*x^3) +
                           (630/13)*upper^13*x^2*(239 - 364*x^3 + 14*x^6) -30*upper^14*x*(109 - 490*x^3 + 56*x^6) +
                           4*upper^15*(109 - 2170*x^3 + 686*x^6) +
                           126*upper^10*x*(-9 + 205*x - 354*x^4 + 30*x^7) +
                           315*upper^4*x*(-27 + 70*x + 135*x^3 - 140*x^4 - 108*x^6 + 70*x^7) +
                           90*upper^7*x*(-54 + 385*x + 378*x^3 - 994*x^4 + 105*x^7) - (70/3)*
                           ...
                           (14/11) * upper^11*(162 - 6490*x + 31155*x^4 - 7260*x^7 + 14*x^10) + (15/2)*
                           upper^8*(162 - 1855*x - 2268*x^3 + 10640*x^4 - 3000*x^7 + 14*x^10) +
                           21*upper^5*(162 - 700*x - 1620*x^3 + 2905*x^4 + 2268*x^6 - 2300*x^7 + 14*x^10) +
      ...
      f2 <- function(upper, x) {
        ...
        ret2 = -((7*upper^21)/19683) + (49*upper^20*x)/13122 - (245*upper^19*x^2)/13851 +
          (980*upper^18*x^3)/19683 - (70*upper^17*x*(3 + 49*x^3))/37179 +
          (7*upper^16*x^2*(20 + 49*x^3))/2916 +
          (35*upper^4*(-1 + x)*x*(1 + x + x^2)*(27 - 70*x - 108*x^3 + 70*x^4))/2916 +
          (5*upper^14*x*(-11 + 350*x^3 + 56*x^6))/4374 -
          (upper^15*(-11 + 1190*x^3 + 686*x^6))/6561 +
          (7*upper^10*x*(-9 - 5*x + 234*x^4 + 30*x^7))/1458 -
          (7*upper^11*x*(-90 + 13155*x^3 + 7140*x^6 + 14*x^9))/
          144342 - (35*upper^9*(-55 - 486*x^2 + 380*x^3 + 2700*x^6 + 80*x^9))/78732 +
          ...
          (5*upper^8*(162 - 385*x + 2*x^3*(-1134 + 1645*x + 1440*x^4 + 7*x^7)))/17496 -
          (7*upper^5*x*(420 + x^2*(1620 - 2695*x - 2268*x^3 + 2180*x^4 + 14*x^7)))/8748 +
          (35*upper^2*(162 - 140*x + x^3*(-243 + 105*x + 243*x^3 - 60*x^4 - 81*x^6 + 14*x^7)))/13122 -
          (5*upper^7*x*(54 + 7*x*(-25 + x^2*(-54 + 82*x + 15*x^4))))/1458 +
          (7*upper^6*x^2*(1215 + 7*x*(-425 + x^2*(-486 + 25*x*(25 + x^3)))))/13122
      ...
      f3 <- function(upper, x) {
        ...
        ret3 = (1/26244)*((28*upper^21)/3 - 6561*x -
                           98*upper^20*x + (8820*upper^19*x^2)/19 + (9800*x^3)/3 +
                           3402*x^5 + (1295*x^9)/6 + (2268*x^11)/11 - (18*x^15)/143 -
                           (7*x^21)/138567 - (280/3)*upper^18*(1 + 14*x^3) + (840/17)*upper^17*
                           x*(17 + 49*x^3) - 63*upper^16*x^2*(55 + 49*x^3) +
                           (70/3)*upper^3*(1 + x^3)^2*(280 - 729*x^2 + 280*x^3) + (630/13)*
                           upper^13*x^2*(239 + 364*x^3 + 14*x^6) -
                           ...
                           81*upper*(-81 + 140*x + 105*x^4 + 60*x^7 + 14*x^10) +
                           21*upper^5*(-162 + 700*x - 1620*x^3 + 2905*x^4 - 2268*x^6 + 2300*x^7 + 14*x^10) -
                           (15/2) * upper^8*(-162 + 1855*x - 2268*x^3 + 10640*x^4 + 3000*x^7 +
                                               14*x^10) + (14/11)*upper^11*(-162 + 6490*x + 31155*x^4 + 7260*x^7 + 14*x^10) -
                           70*upper^2*(-162 + 140*x - 243*x^3 + 105*x^4 - 243*x^6 + 60*x^7 -
                                         81*x^9 + 14*x^10))
      ...
      f4 <- function(upper, x) {
        ...
        ret4 = (-140*upper*x+140*x+(165*((upper-x)^8-
                                          (x-1)^8)-28*((x-1)^11+(upper-x)^11))/22-21*((x-1)^5+(upper-x)^5)+70*upper^2+81*upper-151)/162
      ...
      f5 <- function(upper, x) {
        ...
        ret5 = -((7*upper^21)/19683) + (49*upper^20*x)/13122 - (245*upper^19*x^2)/13851 +
          (980*upper^18*x^3)/19683 - (70*upper^17*x*(3 + 49*x^3))/37179 +
          (7*upper^16*x^2*(20 + 49*x^3))/2916 -
          ...
          (5*upper^14*x*(-11 + 350*x^3 + 56*x^6))/4374 +
          (7*upper^10*x*(-9 - 5*x + 234*x^4 + 30*x^7))/1458 +
          (35*upper^4*x*(-27 + 70*x + 135*x^3 - 140*x^4 - 108*x^6 + 70*x^7))/2916 -
          (5*upper^7*x*(54 - 175*x - 378*x^3 + 574*x^4 + 105*x^7))/1458 +
          (7*upper^6*x^2*(1215 - 2975*x - 3402*x^3 + 4375*x^4 + 175*x^7))/13122 -
          (7*upper^5*x*(420 + 1620*x^2 - 2695*x^3 - 2268*x^5 + 2180*x^6 + 14*x^9))/8748 -
          (7*upper^11*x*(-90 + 13155*x^3 + 7140*x^6 + 14*x^9))/144342 -
          (35*upper^9*(-55 - 486*x^2 + 380*x^3 + 2700*x^6 + 80*x^9))/78732 +
          (1/324)*upper*(81 - 140*x + 105*x^4 - 60*x^7 + 14*x^10) +
          (5*upper^8*(162 - 385*x - 2268*x^3 + 3290*x^4 + 2880*x^7 + 14*x^10))/17496 +
          (35*upper^2*(162 - 140*x - 243*x^3 + 105*x^4 + 243*x^6 - 60*x^7 - 81*x^9 + 14*x^10))/13122 +
          (3647/3 - (933201*x)/374 - (413910*x^2)/247 +
             6860*x^3 - (952560*x^4)/187 + (45927*x^5)/13 -
             4802*x^6 + (34020*x^7)/11 - (17010*x^8)/13 +
             (2135*x^9)/2 - (3969*x^10)/11 - (1085*x^12)/33 + (38*x^15)/
             143 - (35*x^18)/7293 + (7*x^21)/138567)/26244
      ...
      f6 <- function(upper,x) {
        ...
        ret6 = (1/162)*(-151 + 81*upper + 70*upper^2 + 21*((upper - x)^5 +
                                                            (-1 + x)^5) + (15/2)*((upper - x)^8 - (-1 + x)^8) +
      ...
      f7 <- function(upper, x) {
        ret7 = (1/162)*(-151 + 21*(-1 + x)^5 - (15/2)*(-1 + x)^8 + (14/11)*(-1 + x)^11 + 221*x - 70*x^2)
        return(ret7)
      }
      ...
      f8 <- function(upper, x) {
        ...
        ret8 = (7*upper^21)/19683 - (49*upper^20*x)/13122 + (245*upper^19*x^2)/
          13851 - (70*upper^18*(-1 + 14*x^3))/19683 - (7*upper^16*x^2*(-55 + 49*x^3))/2916 +
          (70*upper^17*x*(-17 + 49*x^3))/37179 -
          (35*upper^3*(-1 + x^3)^2*(-280 - 729*x^2 + 280*x^3))/39366 +
          (35*upper^13*x^2*(239 - 364*x^3 + 14*x^6))/18954 -
          (5*upper^14*x*(109 - 490*x^3 + 56*x^6))/4374 +
          (upper^15*(109 - 2170*x^3 + 686*x^6))/
          6561 + (7*upper^10*x*(-9 + 205*x - 354*x^4 + 30*x^7))/1458 +
          (35*upper^4*x*(-27 + 70*x + 135*x^3 - 140*x^4 - 108*x^6 + 70*x^7))/2916 +
          (5*upper^7*x*(-54 + 385*x + 378*x^3 - 994*x^4 + 105*x^7))/1458 -
          (35*upper^12*(-59 + 1101*x^3 - 651*x^6 + 7*x^9))/39366 -
          (35*upper^9*(-265 - 486*x^2 + 4580*x^3 - 3180*x^6 + 80*x^9))/78732 -
          (7*upper^6*(-350 - 1215*x^2 + 4025*x^3 + 3402*x^5 - 5425*x^6 + 175*x^9))/13122 +
          (7*upper^11*(162 - 6490*x + 31155*x^4 - 7260*x^7 + 14*x^10))/144342 +
          (5*upper^8*(162 - 1855*x - 2268*x^3 + 10640*x^4 - 3000*x^7 + 14*x^10))/17496 +
          (7*upper^5*(162 - 700*x - 1620*x^3 + 2905*x^4 + 2268*x^6 - 2300*x^7 + 14*x^10))/8748 +
          (1/324)*upper*(81 - 140*x + 105*x^4 - 60*x^7 + 14*x^10) +
          (35*upper^2*(162 - 140*x - 243*x^3 + 105*x^4 + 243*x^6 - 60*x^7 -
                         81*x^9 + 14*x^10))/13122 +
          (43379/33 - (6561*x)/2 + (252315*x^2)/247 + (4900*x^3)/3 +
             (229635*x^4)/187 - 1701*x^5 - 1078*x^6 + (17010*x^8)/13 + (2450*x^9)/3 +
             (3969*x^10)/11)/26244
      ...
      f9 <- function(upper, x) {
        ret9 =  -((7*upper^21)/19683) + (49*upper^20*x)/13122 - (245*upper^19*x^2)/
          13851 + (980*upper^18*x^3)/19683 + (7*upper^16*x^2*(-20 + 49*x^3))/2916 -
          (70*upper^17*x*(-3 + 49*x^3))/37179 + (35*upper^3*(1 + x^3)^2*(280 - 729*x^2 + 280*x^3))/39366 +
          ...
          (-6561*x + (9800*x^3)/3 + 980*x^6 + (1505*x^9)/6 +
             (1085*x^12)/33 + (38*x^15)/143 + (35*x^18)/7293 + (7*x^21)/138567)/26244
        return(ret9)
      }


      f10 <- function(upper, x) {
        ret10 = -((7*upper^21)/19683) + (49*upper^20*x)/13122 - (245*upper^19*x^2)/
          13851 + (70*upper^18*(1 + 14*x^3))/19683 - (70*upper^17*x*(17 + 49*x^3))/
          37179 + (7*upper^16*x^2*(55 + 49*x^3))/2916 -
          (35*upper^4*x*(1 + x)*(1 + (-1 + x)*x)*(-27 + 70*x - 108*x^3 + 70*x^4))/2916 +
          ...
          (5*upper^8*x*(-1575 + 2*x^2*(1134 - 5215*x - 1440*x^4 + 7*x^7)))/17496 +
          (7*upper^5*(-162 + 700*x + x^3*(-1620 + 2905*x - 2268*x^3 + 2300*x^4 + 14*x^7)))/8748 -
          (35*upper^2*(-162 + 140*x + x^3*(-243 + 105*x - 243*x^3 + 60*x^4 - 81*x^6 + 14*x^7)))/13122 +
          (5*upper^7*x*(-54 + 7*x*(55 + x^2*(-54 + 142*x + 15*x^4))))/
          1458 - (7*upper^6*(350 + x^2*(-1215 + 7*x*(575 + x^2*(-486 + 25*x*(31 + x^3))))))/13122
      ...
      f12 <- function(upper, x) {
        ret12 = -((7*upper^21)/19683) + (49*upper^20*x)/13122 - (245*upper^19*x^2)/13851 +
      ...
      f14 <- function(upper, x) {
        ret14 = upper/2 + (35*upper^2)/81 - (7*upper^5)/54 + (5*upper^8)/108 - (7*upper^11)/891
        return(ret14)
      }
      ...
      for (i in seq_along(length(x))) {
        ...
        if (x[i] >= 0 & x[i] <= 1) {
          if ( upper[i] <= x[i] - 1) {
            ...
            ret[i] = f1(upper = upper[i], x =x[i])
          } else if (upper[i] >= 0 & upper[i] <= x[i]) {
            ret[i] = f1(upper  = 0, x = x[i]) + f2(upper = upper[i], x = x[i])
          } else if (upper[i] >= x[i] & upper[i] <= 1) {
          ...
          if(upper[i] <= x[i] - 1) {
            ...
            ret[i] = (1/162)*(567/22 + 81*upper[i] + 70*upper[i]^2 + 21*(upper[i] - x[i])^5 + (15/2)*(upper[i] - x[i])^8 +
                                (14/11)*(upper[i] - x[i])^11 - 81*x[i] - 140*upper[i]*x[i] + 70*x[i]^2)
          } else if (upper[i] >= x[i] & upper[i] <= x[i] + 1) {
            ret[i] = 7/44 + (1/162)*(81*upper[i] + 70*upper[i]^2 -
                                       21*(upper[i] - x[i])^5 + (15/2)*(upper[i] - x[i])^8 - (14/11)*(upper[i] - x[i])^11 - 81*x[i] -
                                       140*upper[i]*x[i] + 70*x[i]^2)
          ...
          if (upper[i] <= -1) {
            ...
            ret[i] = f8(upper = upper[i], x = x[i])
          } else if (upper[i] >= x[i] & upper[i] <= 0) {
            ret[i] = f8(upper = x[i], x= x[i]) + f9(upper = x[i], x= x[i])
          } else if (upper[i] >= 0 & upper[i] <= x[i] + 1) {
          ...
          if (upper[i] <= -1) {
            ...
            ret[i] = f12(upper =upper[i], x = x[i])
          } else if (upper[i] >= x[i] + 1 & upper[i] <= 0) {
            ret[i] = f12(upper = x[i] + 1, x = x[i]) + f13(upper = upper[i], x = x[i])
          } else if (upper[i] >= 0 & upper[i] <= 1) {
            ret[i] = f12(upper = x[i] + 1, x = x[i]) + f13(upper = 0, x = x[i]) + f14(upper = upper[i], x = x[i])
          } else if (upper[i] >= 1) {
            ret[i] = f12(upper = x[i] + 1, x = x[i]) + f13(upper = 0, x = x[i]) + f14(upper = 1, x = x[i])
          }
        } else if (x[i] <= -2) {
          if (upper[i] <= -1) {
            ret[i] = 0
          } else if (upper[i] >= -1 & upper[i] <= 0) {
            ret[i] = 7/44 + upper[i]/2 + (35*upper[i]^2)/81 + (7*upper[i]^5)/54 + (5*upper[i]^8)/108 + (7*upper[i]^11)/891
          } else if (upper[i] >= 0 & upper[i] <= 1) {
            ret[i] = 7/44 + upper[i]/2 + (35*upper[i]^2)/81 - (7*upper[i]^5)/54 + (5*upper[i]^8)/108 - (7*upper[i]^11)/891
          } else if (upper[i] >= 1) {
            ret[i] = upper[i]
