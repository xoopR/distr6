      ...
      for (i in seq_along(x)) {
        if (x[i] >= 0 & x[i] <= 1) {
          if (upper[i] == Inf | upper[i] > 1) {
            ...
            ret[i] <- ((245 * x[i]^19) / 303046029 + (35 * x[i]^13) / 34749 +
                         (35 * x[i]^9) / 81 -
                      (245 * x[i]^8) / 198 + (3605 * x[i]^7) / 2187 -
                        (175 * x[i]^6) / 117 +
                      (2695 * x[i]^4) / 2187 - (105 * x[i]^2) / 187 -
                        (2450 * x[i]) / 6561 + 175 / 494) +
              fixed1(x = x[i], upper = upper[i])
          } else if (upper[i] >= 0 & upper[i] <= x[i]) {
            ret[i] <- (245 * x[i]^19) / 303046029 +
              (35 * x[i]^13) / 34749 + (35 * x[i]^9) / 81 +
              - (245 * x[i]^8) / 198 + (3605 * x[i]^7) / 2187 -
              (175 * x[i]^6) / 117 + (2695 * x[i]^4) / 2187 -
              (105 * x[i]^2) / 187 - (2450 * x[i]) / 6561 + 175 / 494 +
              fixed2(x = x[i], upper = upper[i])
          } else if (upper[i] >= x[i] & upper[i] <= 1) {
            ret[i] <- 175 / 494  - (2450 * x[i]) / 6561 - (105 * x[i]^2) / 187  +
              (245 * x[i]^4) / 2187 -
              (175 * x[i]^6) / 117 + (3815 * x[i]^7) / 2187 - (245 * x[i]^8) / 198 +
              (35 * x[i]^9) / 81 -
          ...
          if (upper[i] == Inf | upper[i] > 1) {
            ...
            ret[i] <- 11200 / 20007 - (3430 * x[i]) / 2187 + (3920 * x[i]^2) / 1683  -
              ...
              (490 * x[i]^5) / 99 + (1435 * x[i]^6) / 351 - (2135 * x[i]^7) / 729 +
              (245 * x[i]^8) / 198 - (35 * x[i]^9) / 81 + (1085 * x[i]^10) / 6561 -
              (665 * x[i]^13) / 312741 + (35 * x[i]^16) / 625482 -
              (245 * x[i]^19) / 303046029 + fixed4(upper = upper[i], x = x[i])
          } else {
            ret[i] <- 0
          }
        } else if (x[i] >= - 2 & x[i] <= - 1) {
          if (upper[i] > - 1 & upper[i] <= x[i] + 1) {
            ret[i] <- 11200 / 20007 + (5390 * x[i]) / 6561 + (3920 * x[i]^2) / 1683  + (
              1400 * x[i]^3) / 351 + (3185 * x[i]^4) / 729 + (490 * x[i]^5) / 99 +
              (1435 * x[i]^6) / 351 + (4900 * x[i]^7) / 2187 + (245 * x[i]^8) / 198 +
          ...
          if (upper[i] > -1 & upper[i] <= x[i]) {
            ret[i] <- (- (35 * x[i]^9) / 81 - (245 * x[i]^8) / 198 -
                         (4900 * x[i]^7) / 2187 - (175 * x[i]^6) / 117 +
                       (2695 * x[i]^4) / 2187 - (105 * x[i]^2) / 187 -
                         (2450 * x[i]) / 6561 + 175 / 494) +
              fixed1(x = x[i], upper = upper[i])
            ...
            ret[i] <- - (490 * x[i]^19) / 303046029 - (35 * x[i]^16) / 625482 -
              (980 * x[i]^13) / 312741 -
              (1085 * x[i]^10) / 6561 - (35 * x[i]^9) / 81 - (245 * x[i]^8) / 198 -
              (5110 * x[i]^7) / 2187 - (175 * x[i]^6) / 117  +
              (245 * x[i]^4) / 2187 - (105 * x[i]^2) / 187 - (2450 * x[i]) / 6561 +
              175 / 494 - fixed2(upper = upper[i], x = x[i])
          } else if (upper[i] >= 0 & upper[i] <= x[i] + 1) {
            ret[i] <- - (490 * x[i]^19) / 303046029 - (35 * x[i]^16) / 625482 -
              (980 * x[i]^13) / 312741 - (1085 * x[i]^10) / 6561 -
              (35 * x[i]^9) / 81 - (245 * x[i]^8) / 198 -
              (5110 * x[i]^7) / 2187 - (175 * x[i]^6) / 117 +
              (245 * x[i]^4) / 2187 - (105 * x[i]^2) / 187 -
              (2450 * x[i]) / 6561 + 175 / 494 + fixed3(x = x[i], upper = upper[i])
          } else if (upper[i] == Inf | upper[i] > x[i] + 1) {
            ret[i] <- fixed5(x = x[i])
          } else {
            ret[i] <- 0
      ...
      for (i in seq_along(x)) {
        ...
        if (x[i] >= 0 & x[i] <= 1) {
          if (upper[i] <= x[i] - 1) {
            ...
            ret[i] <- f1(upper  = 0, x = x[i]) + f2(upper = x[i], x = x[i]) +
              f3(upper = upper[i], x  = x[i])
          } else if (upper[i] >= 1 & upper[i] <= x[i] + 1) {
            ret[i] <- f1(upper  = 0, x = x[i]) + f2(upper = x[i], x = x[i]) +
              f3(upper = 1, x = x[i]) + f4(upper = upper[i], x = x[i])
          } else if (upper[i] >= x[i] + 1) {
            ret[i] <- f1(upper  = 0, x = x[i]) + f2(upper = x[i], x = x[i]) +
              f3(upper = 1, x = x[i]) + f4(upper = x[i] + 1, x = x[i]) +
              (upper[i] - x[i] - 1)
          }
        } else if (x[i] >= 1 & x[i] <= 2) {
          if (upper[i] <= x[i] - 1) {
            ...
            ret[i] <- f5(upper = 1, x = x[i]) + f6(upper = x[i], x = x[i]) +
              f7(upper = upper[i], x = x[i])
          } else if (upper[i] >= x[i] + 1) {
            ret[i] <- f5(upper = 1, x = x[i]) + f6(upper = x[i], x = x[i]) +
              f7(upper = x[i] + 1, x = x[i]) + (upper[i] - x[i] - 1)
          }
        } else if (x[i] >= 2) {
          if (upper[i] <= x[i] - 1) {
            ret[i] <- 0
            ...
            ret[i] <- (1 / 162) *
              (567 / 22 + 81 * upper[i] + 70 * upper[i]^2 + 21 * (upper[i] - x[i])^5 +
                 (15 / 2) * (upper[i] - x[i])^8 + (14 / 11) * (upper[i] - x[i])^11 -
                 81 * x[i] - 140 * upper[i] * x[i] + 70 * x[i]^2)
          } else if (upper[i] >= x[i] & upper[i] <= x[i] + 1) {
            ret[i] <- 7 / 44 + (1 / 162) *
              (81 * upper[i] + 70 * upper[i]^2 - 21 * (upper[i] - x[i])^5 +
                 (15 / 2) * (upper[i] - x[i])^8 - (14 / 11) * (upper[i] - x[i])^11 -
                 81 * x[i] - 140 * upper[i] * x[i] + 70 * x[i]^2)
          } else if (upper[i] >= x[i] + 1) {
            ret[i] <- upper[i] - x[i]
          ...
          if (upper[i] <= - 1) {
            ...
            ret[i] <- f8(upper = x[i], x = x[i]) + f9(upper = 0, x = x[i]) +
              f10(upper = upper[i], x = x[i])
          } else if (upper[i] >= x[i] + 1 & upper[i] <= 1) {
            ret[i] <- f8(upper = x[i], x = x[i]) + f9(upper = 0, x = x[i]) +
              f10(upper = x[i] + 1, x = x[i]) + f11(upper = upper[i], x = x[i])
          } else if (upper[i] >= 1) {
            ret[i] <-  f8(upper = x[i], x = x[i]) + f9(upper = 0, x = x[i]) +
              f10(upper = x[i] + 1, x = x[i]) + f11(upper = 1, x = x[i]) + (upper[i] - 1)
          }
        } else if (x[i] >= - 2 & x[i] <= - 1) {
          if (upper[i] <= - 1) {
            ret[i] <- 0
            ...
            ret[i] <- f12(upper = x[i] + 1, x = x[i]) + f13(upper = 0, x = x[i]) +
              f14(upper = upper[i], x = x[i])
          } else if (upper[i] >= 1) {
            ret[i] <- f12(upper = x[i] + 1, x = x[i]) + f13(upper = 0, x = x[i]) +
              f14(upper = 1, x = x[i])
          }
          ...
          if (upper[i] <= - 1) {
            ...
            ret[i] <- 7 / 44 + upper[i] / 2 + (35 * upper[i]^2) / 81 +
              (7 * upper[i]^5) / 54 + (5 * upper[i]^8) / 108 +
              (7 * upper[i]^11) / 891
          } else if (upper[i] >= 0 & upper[i] <= 1) {
            ret[i] <- 7 / 44 + upper[i] / 2 + (35 * upper[i]^2) / 81 -
              (7 * upper[i]^5) / 54 + (5 * upper[i]^8) / 108 - (7 * upper[i]^11) / 891
          } else if (upper[i] >= 1) {
            ret[i] <- upper[i]
          }
        }
