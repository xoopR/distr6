...
#' \code{getscaledmean()} \tab numeric \tab Return mean of scaled distribution. \cr
#' \code{getscaledsd()} \tab numeric \tab Return standard deviation of scaled distribution. \cr
#' }
#'
#'@section Setters:
#' \tabular{lll}{
#' \strong{Method} \tab \strong{Input Type} \tab \strong{Details} \cr
#' \code{setscaledmean(mean)} \tab numeric \tab Set mean to scale distribution to. \cr
#' \code{setscaledsd(sd)} \tab numeric \tab Set standard deviation to scale distribution to. \cr
#' }
#'
#' @examples
#' \dontrun{
