.plot_continuous <- function(fun, plotStructure, name, ...){
  ...
  if("pdf" %in% fun){
    ...
    plots$pdf = c(list(x = plotStructure$points, y = plotStructure$pdf, type = "l"),
                  args)
  }
  ...
  if ("cdf" %in% fun){
    ...
    plots$cdf = c(list(x = plotStructure$points, y = plotStructure$cdf, type = "l"),
                  args)
  }
  ...
  if("quantile" %in% fun){
    ...
    plots$quantile = c(list(x = plotStructure$cdf, y = plotStructure$points, type = "l"),
                       args)
    }
  ...
  if ("survival" %in% fun){
    ...
    plots$survival = c(list(x = plotStructure$points, y = plotStructure$survival, type = "l"),
                       args)
  }
  ...
  if ("hazard" %in% fun){
    ...
    plots$hazard = c(list(x = plotStructure$points, y = plotStructure$hazard, type = "l"),
                     args)
  }
  ...
  if("cumhazard" %in% fun){
    ...
    plots$cumhazard = c(list(x = plotStructure$points, y = plotStructure$cumhazard, type = "l"),
                        args)
  }
