...
WeightedDiscrete$set("active","name","WeightedDiscrete")
WeightedDiscrete$set("active","short_name","WeightDisc")
WeightedDiscrete$set("active","description","WeightedDiscrete Probability Distribution.")
