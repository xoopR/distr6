...
test_that("parameterisation", {
  ...
  expect_silent(FDistribution$new(location = 2))
  expect_error(FDistribution$new(df1 = 1, df2 = -1))
  expect_error(FDistribution$new(df1 = -1, df2 = 1))
  expect_error(FDistribution$new(location = -2))
  ...
  expect_equal(FDistribution$new(location = 5)$getParameterValue("location"), 5)
})
