...
test_that("check continuous Truncated wrapper", {
  continuousTester2 = HuberizedDistribution$new(continuousTester, lower = 1, upper = 5)
  expect_equal(continuousTester2$pdf(-100), continuousTester$cdf(1))
  expect_equal(continuousTester2$pdf(100), 1-continuousTester$cdf(5))
  expect_equal(continuousTester2$pdf(3), continuousTester$pdf(3))
})

test_that("check discrete Truncated wrapper", {
  discreteTester2 = HuberizedDistribution$new(discreteTester, lower = 1, upper = 5)
  expect_equal(discreteTester2$pdf(-100), discreteTester$cdf(1))
  expect_equal(discreteTester2$pdf(100), 1-discreteTester2$cdf(5))
  expect_equal(discreteTester2$pdf(3), discreteTester2$pdf(3))
})
