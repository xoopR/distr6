...
test_that("parameterisation",{
  expect_message(Normal$new())
  expect_silent(Normal$new(var = 1))
  expect_silent(Normal$new(sd = 1))
  expect_silent(Normal$new(prec = 1))
  expect_message(Normal$new(var = 2, sd = 3))
  expect_message(Normal$new(var = 2, prec = 3))
  expect_message(Normal$new(prec = 2, sd = 3))
  expect_message(Normal$new(var = 2, sd = 3, prec = 4))
  ...
  expect_equal(Normal$new(var = 2, sd = 3)$getParameterValue("var"), 2)
  expect_equal(Normal$new(var = 2, prec = 3)$getParameterValue("var"), 2)
...
test_that("silent statistics",{
  ...
  expect_silent(Normal$new(var=1)$expectation())
  expect_silent(Normal$new(var=1)$entropy())
  expect_silent(Normal$new(var=1)$mgf(1))
  expect_silent(Normal$new(var=1)$cf(1))
  expect_silent(Normal$new(var=1)$survival(1))
  expect_silent(Normal$new(var=1)$hazard(1))
  expect_equal(Normal$new(var=1)$hazard(5),dnorm(5)/pnorm(5, lower.tail = F))
  expect_silent(Normal$new(var=1)$cumHazard(1))
  ...
  expect_equal(Normal$new(mean = 4)$expectation(), 4)
