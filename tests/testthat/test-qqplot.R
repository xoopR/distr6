...
test_that("silent", {
  ...
  expect_silent(qqplot(rnorm(n = 20, mean = 15, sd = sqrt(30)), c(3, 6, 8, 2, 0, 6, 2, 7, 9, 4, 3, 7, 4, 5, 11, 1, 10, 6, 6, 3)))
  ...
  expect_silent(qqplot(Normal$new(mean = 15, sd = sqrt(30)), ChiSquared$new(df = 15), idline = FALSE))
})
